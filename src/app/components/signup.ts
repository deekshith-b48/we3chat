  ...
  template: `
    <div class="min-h-screen flex">
      ...
      <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 via-indigo-600 to-blue-700 relative overflow-hidden">
        ...
        <div class="absolute top-1/3 right-32 w-16 h-16 bg-white bg-opacity-10 rounded-full"></div>
      </div>
      ...
      <div class="flex-1 flex flex-col justify-center px-8 sm:px-12 lg:px-16 xl:px-20">
        <div class="w-full max-w-md mx-auto">
          ...
          <div class="text-center mb-8">
            ...
            <p class="text-gray-600">Start your journey with we3chat today</p>
          </div>
          ...
          <form (ngSubmit)="onSignup()" class="space-y-6">
            ...
            <div>
              ...
              <p *ngIf="confirmPasswordError()" class="mt-1 text-sm text-red-600">{{ confirmPasswordError() }}</p>
            </div>
            ...
            <div class="flex items-start">
              ...
              <label for="agreeTerms" class="ml-3 text-sm text-gray-600">
                I agree to the 
                <button type="button" class="text-blue-600 hover:text-blue-500 font-medium">Terms of Service</button> 
                and 
                <button type="button" class="text-blue-600 hover:text-blue-500 font-medium">Privacy Policy</button>
              </label>
            </div>
            <p *ngIf="termsError()" class="mt-1 text-sm text-red-600">{{ termsError() }}</p>

            <!-- Error Message -->
            <div *ngIf="signupError()" class="p-3 bg-red-50 border border-red-200 rounded-lg">
              <p class="text-sm text-red-600">{{ signupError() }}</p>
            </div>

            <!-- Success Message -->
            <div *ngIf="signupSuccess()" class="p-3 bg-green-50 border border-green-200 rounded-lg">
              <p class="text-sm text-green-600">{{ signupSuccess() }}</p>
            </div>
          ...
          <p class="mt-8 text-center text-gray-600">
            ...
            <a [routerLink]="['/login']" class="text-blue-600 hover:text-blue-500 font-medium ml-1">
              Sign in instead
            </a>
          </p>
        </div>
...
export class SignupComponent {
  ...
  onSignup() {
    ...
    // Simulate API call
    setTimeout(() => {
      this.signupSuccess.set('Account created successfully! Please check your email to verify your account.');
  ...
  onGoogleSignup() {
    this.signupError.set('Google OAuth integration coming soon...');
  }
  ...
  validateForm(): boolean {
    ...
    if (!this.signupForm.username) {
      ...
      isValid = false;
    } else if (this.signupForm.username.length < 3) {
    ...
    if (!this.signupForm.agreeTerms) {
      this.termsError.set('You must agree to the terms and privacy policy');
      isValid = false;
    }
